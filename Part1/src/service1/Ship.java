...
import static service3.Port.ContainerCrane.CONTAINER_CRANE_CAPACITY;
import static service3.Port.BulkCrane.BULK_CRANE_CAPACITY;
import static service3.Port.LiquidCrane.LIQUID_CRANE_CAPACITY;
...
public class Ship {
    ...
    private int generatePeriod() {
        return switch (this.cargo) {
            case LIQUID -> this.weight / LIQUID_CRANE_CAPACITY;
            case BULK -> this.weight / BULK_CRANE_CAPACITY;
            case CONTAINER -> this.weight / CONTAINER_CRANE_CAPACITY;
        };
    }
